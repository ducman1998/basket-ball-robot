...
== Project Overview
This repository contains the source code and electronic schematics developed for the DeltaX Competition (Basketball Track) at the University of Tartu, including mechanics, electronics, firmware, and ROS2 software.
Our team won 🥉 3rd prize out of 10 teams.
In terms of motion performance, our robot was one of the fastest in the competition and reached the practical platform limits: up to `2.5 m/s` linear speed and about `8 rad/s` turning speed.
...
The embedded viewer below allows quick interaction with the CAD model directly from this document.
If your AsciiDoc renderer blocks embedded web content, open the direct Fusion link above.

++++
<iframe
  src="https://gmail1315991.autodesk360.com/shares/public/SH28cd1QT2badd0ea72bee33155ba9d54c82?mode=embed"
  width="100%"
  height="680"
