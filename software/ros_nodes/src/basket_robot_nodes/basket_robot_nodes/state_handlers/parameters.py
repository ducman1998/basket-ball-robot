...
class Parameters:
    ...
    MANI_MAX_ALIGN_LINEAR_SPEED: Final[float] = 1.75  # m/s
    ...
    MANI_PID_ANGULAR_ALIGN: Final[list[float]] = [6.0, 0.0, 0.1]  # [Kp, Ki, Kd]
    ...
    MANI_PID_ANGULAR_ALIGN_BASKET_ADV: Final[list[float]] = [8.0, 0.0, 0.01]  # [Kp, Ki, Kd]
    ...
    MANI_ALIGN_BASKET_ADV_MAX_ANGULAR_SPEED: Final[float] = 4.0  # rad/s
