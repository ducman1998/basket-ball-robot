...
class Parameters:
    ...
    MANI_MAX_ALIGN_ANGULAR_SPEED: Final[float] = 10.0  # rad/s
    ...
    MANI_PID_LINEAR_ALIGN_BASKET_ADV: Final[list[float]] = [2.0, 0.0, 0.05]  # [Kp, Ki, Kd]
    MANI_PID_ANGULAR_ALIGN_BASKET_ADV: Final[list[float]] = [12.0, 0.0, 0.01]  # [Kp, Ki, Kd]
    ...
    MANI_SEARCH_BASKET_ANGULAR_SPEEDS: Final[Tuple[float, float]] = (2.0, 6.0)  # rad/s
    MANI_SEARCH_BASKET_MAX_ANGULAR_SPEED: Final[float] = 10.0  # rad/s
    ...
    MANI_ALIGN_BASKET_ADV_MAX_LINEAR_SPEED: Final[float] = 3.0  # m/s
    MANI_ALIGN_BASKET_ADV_MAX_ANGULAR_SPEED: Final[float] = 12.0  # rad/s
    MANI_ALIGN_BASKET_ADV_DIS_THRESHOLD_MM: Final[float] = 800.0  # mm
    MANI_ALIGN_BASKET_ADV_DIS_ODOM_THRESHOLD_MM: Final[float] = 150.0  # mm
    MANI_ALIGN_BASKET_ADV_ENABLED_DIST_PID_MM: Final[float] = 300.0  # m
    ...
    MAIN_TIMEOUT_ALIGN_BASKET_ADVANCED_TOTAL: Final[float] = 3.5  # timeout
    ...
    MAIN_TIMEOUT_THROW_BALL: Final[float] = 1.5  # seconds before re-trying to throw ball
