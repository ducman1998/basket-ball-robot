...
class Parameters:
    ...
    MANI_PID_LINEAR_ALIGN: Final[list[float]] = [1.5, 0.0, 0.1]  # [Kp, Ki, Kd]
    MANI_PID_ANGULAR_ALIGN: Final[list[float]] = [10.0, 0.0, 0.1]  # [Kp, Ki, Kd]
    ...
    MANI_PID_ANGULAR_ALIGN_BASKET_ADV: Final[list[float]] = [15.0, 0.0, 0.1]  # [Kp, Ki, Kd]
    ...
    MANI_BALL_ALIGN_ANGLE_THRESHOLD_DEG: Final[float] = 10.0  # degrees
