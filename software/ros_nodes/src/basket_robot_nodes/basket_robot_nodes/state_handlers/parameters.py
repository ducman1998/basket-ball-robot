...
class Parameters:
    ...
    BASE_WARMUP_RAMP_DURATION: Final[float] = 0.2  # seconds
    ...
    BASE_DISCRETE_TURN_STOP_DURATION: Final[float] = 0.3  # seconds
    ...
    MAIN_TIMEOUT_TURN_TO_CANDIDATE_BALL: Final[float] = 1.0  # seconds before re-searching for ball
