...
image:../images/checkerboard_image_01.png[An example of checkerboard captured, width=400, align=center]
...
* Step 3. Extrinsic calibration using Python (with known K, Tcw, and distortion coefficients from MATLAB).
    ...
    2. Calculate the translation vector tbc: tbc = [0, -50, -twc[-1]];
